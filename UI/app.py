...
QUERIES_INFO = {
    ...
    'Q5': {
        'title': 'Νέοι Ιατροί - Κατηγορία Β (<35)',
        'description': 'Νέοι ιατροί με τις περισσότερες επεμβάσεις Κατηγορίας Β (Χειρουργικές – Επεμβατικές – Ενδοσκοπικές).',
        'file': 'sql/Q05.sql'
    },
    'Q6': {
    ...
    'Q11': {
        'title': 'Ιατροί με Χαμηλή Συμμετοχή (Κατηγορία Β)',
        'description': 'Ιατροί με τουλάχιστον 5 λιγότερες επεμβάσεις Κατηγορίας Β από τον κορυφαίο ιατρό του έτους.',
        'file': 'sql/Q11.sql'
    },
    'Q12': {
